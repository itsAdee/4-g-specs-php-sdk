...
use VerizonLib\Authentication\OAuth2Credentials;
use VerizonLib\Authentication\OAuth2CredentialsBuilder;
use VerizonLib\Authentication\Oauth2Manager;
...
class VerizonClient implements ConfigurationInterface
{
    ...
    public function __construct(array $config = [])
    {
        ...
        $this->client = ClientBuilder::init(new HttpClient(Configuration::init($this)))
            ...
            ->authManagers(['oAuth2' => $this->oauth2Manager, 'thingspace_oauth' => $this->thingspaceOauthManager])
            ->build();
